...
public class Neo_Parser {
	...
	public void request() {
		...
		jRequester.makeRequest(
				"https://api.nasa.gov/neo/rest/v1/neo/browse?api_key=Hvhsssfu66mY3kGSEQbbxYsRJ5TZerntwuWlGKph");
...
//	  System.out.println(estimated_diameter.toString());
	...
	Object findKey(String aKey, JSONObject aRoot, int level) {
